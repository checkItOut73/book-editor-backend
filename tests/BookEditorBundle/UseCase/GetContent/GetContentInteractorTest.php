...
use Tests\BookEditorBundle\UseCase\GetContent\Repository\GetChaptersRepositoryStub;
...
use Tests\BookEditorBundle\UseCase\GetContent\Repository\GetParagraphsRepositoryStub;
use Tests\BookEditorBundle\UseCase\GetContent\Repository\GetVersesRepositoryStub;

/**
 * @covers \App\BookEditorBundle\UseCase\GetContent\GetContentInteractor
 */
class GetContentInteractorTest extends TestCase
{
    ...
    private GetContentJsonPresenterStub $presenter;
    private GetContentInteractor $interactor;
    ...
    public function setUp(): void
    {
        ...
        $this->presenter = new GetContentJsonPresenterStub();

        $this->interactor = new GetContentInteractor(
